...
function rotateArrayBySwapping(array, k) {
    ...
    reversePartOfArray(array, 0, lastIndex);           // Reverse entire array
    reversePartOfArray(array, 0, shifts - 1);          // Reverse everything before shifts (k)
    reversePartOfArray(array, shifts, lastIndex);      // Reverse from shifts (k) to end
    return array;
}

function reversePartOfArray(array, start, end) {
    while (start < end) {
